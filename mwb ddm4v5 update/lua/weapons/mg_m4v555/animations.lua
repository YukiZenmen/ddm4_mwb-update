...
SWEP.Animations = {
    ...
    ["Equip"] = {
        ...
        Events = {
            ...
            {Time = 0, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Boltback")) end},
            {Time = 0.5, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Boltrelease")) end},
    ...
    ["Reload"] = {
        ...
        Events = {
            ...
            {Time = 0.1, Callback = function(self) self:DisableGrip() end},
            {Time = 0.7, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magout")) end},
            {Time = 1.13, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magin")) end},
            {Time = 1.23, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Hit")) end},
    ...
    ["Reload_Fast"] = {
        ...
        Events = {
            ...
            {Time = 0.3, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magout")) end},
            ...
            {Time = 0.73, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magin")) end},
            {Time = 0.93, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Hit")) end},
    ...
    ["Reload_Empty"] = {
        ...
        Events = {
            ...
            {Time = 0.1, Callback = function(self) self:DisableGrip() end},
            {Time = 0.26, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magout")) end},
            ...
            {Time = 1.13, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magin")) end},
            {Time = 1.23, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Hit")) end},
            {Time = 1.76, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Maghitrelease")) end},
    ...
    ["Reload_Empty_Fast"] = {
        ...
        Events = {
            ...
            {Time = 0.1, Callback = function(self) self:DisableGrip() end},
            {Time = 0.23, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magout")) end},
            ...
            {Time = 0.83, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Magin")) end},
            {Time = 0.9, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Hit")) end},
            {Time = 1.05, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Maghitrelease")) end},
    ...
    ["Reload_Empty_Calsmg_Fast"] = {
        ...
        Events = {
            ...
            {Time = 1.1, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.Maghitrelease")) end},
            {Time = 1.4, Callback = function(self) self:EnableGrip() end},
            {Time = 1.4, Callback = function(self) self:DoSound(Sound("wfoly_plr_ar_mike4_reload_empty_fast_05")) end},
        }
    },
  ...
  ["Reload_Empty_XmagLrg"] = {
   ...
   ["Reload_Empty_XmagLrg_Fast"] = {
    ...
    ["Firemode_Auto"] = {
        ...
        Events = {
            {Time = 0, Callback = function(self) self:EnableGrip() self:AllowRuntimeMagPoseParam(true) end},
            {Time = 0, Callback = function(self) self:DoSound(Sound("INS2.DDM4V5.ROF")) end}
        }
    },
