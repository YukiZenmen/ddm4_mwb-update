...
SWEP.WorldModelOffsets = {
    ...
    Pos = Vector(1.75,-5,-3.5)
}

SWEP.ViewModelOffsets = {
    Aim = {
        Angles = Angle(0, -0.0, 0),
        Pos = Vector(0.01, 3, 0.0)
    },
    Idle = {
        Angles = Angle(0, 0, 0),
        Pos = Vector(0, 0, 0)
    ...
    RecoilMultiplier = 0.36,
    KickMultiplier = 0.93,
    AimKickMultiplier = 0.9
}
...
self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.01,0,0)
self.ViewModelOffsets.Aim.Angles = self.ViewModelOffsets.Aim.Angles + Angle(0, -0.0, 0)
           end
       end
   end
