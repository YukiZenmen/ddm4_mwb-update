...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("INS2.DDM4V5.2")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
function SWEP:doCal1ConversionStats()
    local bSup1 = self:HasAttachment("attachment_vm_silencer_east01")
    local bSup2 = self:HasAttachment("attachment_vm_silencer02")
    local bSup3 = self:HasAttachment("attachment_vm_silencer03")
    local bSup4 = self:HasAttachment("attachment_vm_silencer04")
...
SWEP.Customization = {
    ...
    {"attachment_vm_ar_m4v5_stock", "attachment_vm_ar_m4v5_stock_v2", "attachment_vm_ar_m4v5_stock_v15","attachment_vm_ar_m4v5_customstock", "attachment_vm_ar_m4v5_stockno", "att_vm_stock_heavy01_m4v5", 
    "att_vm_stock_heavy02_m4v5", "att_vm_stock_light01_m4v5", "att_vm_stock_medium01_m4v5"},

    {"attachment_vm_ar_m4v5_mag", "attachment_vm_ar_m4v5_pmag", "attachment_vm_ar_mike4_xmags", "attachment_vm_ar_mike4_xmags2", "attachment_vm_ar_mike4_mag_v5", 
    "attachment_vm_ar_mike4_calsmg", "attachment_vm_ar_m4v5_magsub", "attachment_vm_ar_mike4_mag_v15", "attachment_vm_ar_mike4_mag_v27"},

    {"attachment_vm_ar_m4v5_receiver"},
    ...
    "att_vm_silencer04", "wp_ac858", "wp_atlas7", "wp_crs", "wp_k556", "wp_qdc", "wp_red", "wp_sio", "wp_awc762", "wp_wave"},

    {"att_sight", "attachment_vm_ar_m4v5_carryhandle", "attachment_vm_ar_mike4_carryhandle", "att_vm_minireddot01_tall", "att_vm_minireddot02_tall", "att_vm_minireddot03_tall",
    ...
    "wp_558",       "wp_acog",       "wp_553",       "wp_mw2_szbo",       "wp_ars",       "wp_aems",       "wp_t1_lmo",
    "wp_pbps",       "wp_cw_diamondback",       "wp_bravo4",
    "wp_pkas",       "wp_vk",       "wp_cw_kobra",       "wp_lp_m5_hd",
    "wp_r1x",       "wp_po156",       "wp_cw_quickdot",       "wp_tps330",
    "wp_r4t",       "wp_rg3",       "wp_cw_snappoint",       "wp_x8_mr45",
    "wp_r8t",       "wp_x3",       "wp_fc1",       "wp_x5",       "wp_lco",
    "wp_uh1",       "wp_x8",       "wp_mro_8", "wp_acog_rm45",},

    {"att_laser", "attachment_vm_ar_m4v5_laser01", "attachment_vm_ar_m4v5_laser02", "attachment_vm_ar_m4v5_laser03", "wp_dbala3", "wp_ls321", "wp_mawl", "wp_ngal", "wp_peq", "wp_wrxe"},
    
    {"att_grip", "attachment_vm_ar_m4v5_angledgrip01", "attachment_vm_ar_m4v5_angledgrip02", "attachment_vm_ar_m4v5_stubbygrip01", 
    "attachment_vm_ar_m4v5_stubbygrip02", "attachment_vm_ar_m4v5_vertgrip01", "attachment_vm_ar_m4v5_vertgrip02", 
    "attachment_vm_ar_m4v5_vertgrip03", "attachment_vm_ar_m4v5_grip_cqr", "attachment_vm_ar_m4v5_grip_ldag", "attachment_vm_ar_m4v5_grip_mod3", "attachment_vm_ar_m4v5_grip_shift", "attachment_vm_ar_m4v5_grip_td", "attachment_vm_ar_m4v5_grip_uvg", "attachment_vm_ar_m4v5_grip_wbj"},
